...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-20 flex-1 flex items-center justify-center px-6 pt-24 pb-8">
        <div className="text-center max-w-5xl mx-auto">
        {/* Logo */}
        <div className="flex justify-center mb-3" style={{ animation: 'fadeUp 0.6s ease-out 0.1s forwards', opacity: 0 }}>
          <img src="/logo.png?v=4" alt="Zenith Luxury Detailing" className="h-20 sm:h-24 w-auto" style={{ mixBlendMode: 'lighten' }} />
        </div>

        {/* Divider line between logo and eyebrow */}
        <div className="flex justify-center mb-4" style={{ animation: 'fadeUp 0.6s ease-out 0.15s forwards', opacity: 0 }}>
          <div className="w-96 h-px opacity-30" style={{ background: 'linear-gradient(90deg, transparent, #d4a017, transparent)' }} />
        </div>

        {/* Eyebrow */}
        <div className="inline-flex items-center gap-3 mb-5" style={{ animation: 'fadeUp 0.6s ease-out 0.2s forwards', opacity: 0 }}>
        ...
        {/* Main Headline */}
        <h1
          className="font-display font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight mb-4"
        ...
        {/* Subtext */}
        <p
          className="text-white/60 text-lg md:text-xl font-light tracking-wide mb-7 max-w-2xl mx-auto"
